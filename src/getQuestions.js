...
const getQuestions = async (category, difficulty, callBack) =>{
    const questionApiURL = `https://opentdb.com/api.php?amount=10&category=${category}&difficulty=${difficulty}&type=multiple`
